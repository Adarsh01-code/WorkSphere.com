...
export const Item = ({
    id,label, onClick, icon:Icon, active, documentIcon, level=0 , onExpand, isSearch, expanded
}: ItemProps)  => {
                ...
                >
                    <DropdownMenu>
                        ...
                        >
                            <DropdownMenuItem
                            onClick={onArchive}
                            className="cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-900"
                            >
